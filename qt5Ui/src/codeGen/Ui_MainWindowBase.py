...
class Ui_MainWindowBase(object):
    def setupUi(self, MainWindowBase):
        ...
        self.pushButtonDeloyAll.setGeometry(QtCore.QRect(860, 600, 171, 27))
        ...
        self.pushButtonRebuildDeploy.setGeometry(QtCore.QRect(480, 550, 171, 27))
        ...
        self.pushButtonDeployStopAll.setGeometry(QtCore.QRect(480, 600, 171, 27))
