...
class Ui_MainWindowBase(object):
    def setupUi(self, MainWindowBase):
        ...
        self.pushButtonRebuildDeploy.setGeometry(QtCore.QRect(170, 530, 171, 27))
        ...
        self.pushButtonDeployStopAll.setGeometry(QtCore.QRect(170, 580, 171, 27))
        ...
        self.pushButtonDeployRefresh.setGeometry(QtCore.QRect(360, 530, 171, 27))
